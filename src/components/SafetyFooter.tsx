          ...
          <div className="flex gap-12">
            ...
            <div className="flex flex-col">
              ...
              <ul className="flex flex-col gap-3 font-safetySans text-sm text-safety-light/70">
                {[
                  { country: 'Egypt', num: '+20 122 764 4162', clean: '201227644162' },
                  { country: 'Egypt', num: '+20 100 022 3632', clean: '201000223632' },
                  { country: 'Portugal', num: '+351 937 438 070', clean: '351937438070' }
                ].map(contact => (
                  <li key={contact.clean} className="flex items-center gap-3">
                    <span className="w-16">{contact.country}:</span>
                    <a 
                      href={`https://wa.me/${contact.clean}?text=Hello%20Georeo%20Safety,%20I%27m%20interested%20in%20your%20safety%20boards%20and%20labels.`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 hover:text-[#25D366] transition-colors group"
                      title="Chat on WhatsApp"
                    >
                      <span className="font-safetyMono" dir="ltr">{contact.num}</span>
