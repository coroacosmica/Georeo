...
export default function SafetyHero() {
  const titleWords = 'Advanced Site Safety'.split(' ');
  const subtitle = 'Customizable 3D boards and premium safety labels.';
  ...
  return (
    <section className="relative h-screen bg-transparent overflow-hidden">
      <div className="h-full uppercase items-center w-full absolute z-40 pointer-events-none px-6 md:px-10 flex justify-center flex-col">
        <div className="text-4xl md:text-6xl xl:text-8xl 2xl:text-9xl font-extrabold">
          <div className="flex flex-wrap justify-center space-x-2 md:space-x-4 lg:space-x-6 overflow-hidden text-white font-safetyDisplay">
        ...
        <div className="text-sm md:text-xl xl:text-2xl 2xl:text-3xl mt-4 overflow-hidden text-safety-red font-bold font-safetyMono tracking-wider text-center">
          <div
      ...
      <button
        ...
        className="explore-btn z-50 hover:text-safety-red transition-colors"
