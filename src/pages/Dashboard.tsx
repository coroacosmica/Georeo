  ...
  return (
    <div className="p-8 font-safetySans">
      ...
      <div className="flex justify-between items-center mb-8">
        <h1 className="font-safetyDisplay text-3xl text-white uppercase">Analytics Overview</h1>
        <button className="px-4 py-1.5 text-sm font-medium text-safety-light/70 bg-safety-panel border border-safety-gray/50 rounded hover:bg-white/5 transition-colors flex items-center gap-2">
          <span className="text-safety-orange">↻</span> Refresh Data
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-safety-panel p-6 rounded-lg border border-safety-gray/50">
          ...
          <p className="text-sm text-safety-light/50 mt-1 uppercase tracking-wider font-bold">Total Products</p>
        </div>
        <div className="bg-safety-panel p-6 rounded-lg border border-safety-gray/50">
          <h3 className="font-safetyMono text-3xl font-bold text-blue-500">{newRequests}</h3>
          <p className="text-sm text-safety-light/50 mt-1 uppercase tracking-wider font-bold">New Requests</p>
        </div>
        <div className="bg-safety-panel p-6 rounded-lg border border-safety-gray/50">
          <h3 className="font-safetyMono text-3xl font-bold text-safety-orange">{contactedCount}</h3>
          <p className="text-sm text-safety-light/50 mt-1 uppercase tracking-wider font-bold">Contacted</p>
        </div>
        <div className="bg-safety-panel p-6 rounded-lg border border-safety-gray/50">
          <h3 className="font-safetyMono text-3xl font-bold text-green-500">{completedCount}</h3>
          <p className="text-sm text-safety-light/50 mt-1 uppercase tracking-wider font-bold">Completed</p>
        </div>
      </div>
      ...
      <div className="animate-in fade-in slide-in-from-bottom-2 duration-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-safety-panel p-6 rounded-lg border border-safety-gray/50">
            <p className="text-xs text-safety-light/50 uppercase tracking-wider mb-2">Total Page Views</p>
            <h3 className="font-safetyMono text-3xl font-bold text-white">{pageViews}</h3>
          </div>
          <div className="bg-safety-panel p-6 rounded-lg border border-safety-gray/50">
            <p className="text-xs text-safety-light/50 uppercase tracking-wider mb-2">Unique Visitors</p>
            <h3 className="font-safetyMono text-3xl font-bold text-white">{uniqueVisitors}</h3>
          </div>
          <div className="bg-safety-panel p-6 rounded-lg border border-safety-gray/50">
            <p className="text-xs text-safety-light/50 uppercase tracking-wider mb-2">Products Sold</p>
            <h3 className="font-safetyMono text-3xl font-bold text-white">{productsSold}</h3>
          </div>
          <div className="bg-safety-panel p-6 rounded-lg border border-safety-gray/50">
            <p className="text-xs text-safety-light/50 uppercase tracking-wider mb-2">Conversion Rate</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-safety-panel p-6 rounded-lg border border-safety-gray/50">
            <h4 className="text-sm font-bold text-white uppercase tracking-wider mb-6">Traffic Overview</h4>
          ...
          {/* Top Pages List */}
          <div className="bg-safety-panel p-6 rounded-lg border border-safety-gray/50">
            <h4 className="text-sm font-bold text-white uppercase tracking-wider mb-6">Top Pages Visited</h4>
              ...
              {topPages.map((page, index) => (
                <div key={index} className="flex items-center justify-between text-sm font-safetyMono">
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-safety-light/70 truncate max-w-[120px]">{page.path}</span>
                  </div>
